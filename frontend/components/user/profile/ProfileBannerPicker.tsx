  ...
  return (
    <AlertDialog onOpenChange={handleOpenChange}>
      ...
      >
        ...
        <fieldset className="my-4 flex-1 overflow-y-auto no-scrollbar pr-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {BANNER_LIST.map((banner) => (
              ...
              >
                ...
                />
                <span
                  className={`flex w-full items-center justify-center aspect-video h-32 md:h-40 rounded-2xl p-4 bg-cover bg-center transition-all duration-200 ease-out peer-active:scale-95 peer-focus-visible:ring-2 peer-focus-visible:ring-primary-normal peer-focus-visible:ring-offset-2 ${
                    draft === banner.key
