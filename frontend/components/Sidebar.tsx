...
const Sidebar = () => {
  ...
  return (
    <aside
      className={`h-full transition-all duration-300 w-full md:w-12 xl:w-62.5 overflow-hidden hover:overflow-y-auto lg:border-r bg-white shadow-lg p-5  ${isExpanded ? "md:w-62.5 z-60" : "md:w-12"}`}
    >
      <div
