...
const Navbar = () => {
	...
	const navlinks = [
		...
		},
		{
			id: 4,
			name: "How it works",
			href: "/how-it-works", //change this after making the page
		},
		{
			id: 5,
			name: "Testimonials",
	...
	return (
		...
		<nav className="flex relative items-center justify-between  px-[26px] bg-white py-5">
			<div className="right  flex items-center gap-7">
				{/* Menu Button */}
				<FaBars
					onClick={() => setOpenMenu(true)}
					className="text-[18px]  min-[1140px]:hidden"
				/>
				{/* Logo */}
				<Image
					src={"/academiaHub-logo.png"}
			...
			{/* Nav Links notes: font-size for nav links might be too small */}
